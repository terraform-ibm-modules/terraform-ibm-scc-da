...
| <a name="input_cos_bucket_region"></a> [cos\_bucket\_region](#input\_cos\_bucket\_region) | The region to create the cos bucket.If not provided, scc\_region will be used | `string` | `null` | no |
